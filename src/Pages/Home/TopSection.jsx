        ...
        <div className="container mx-auto ">
          <div className="grid grid-cols-1 sm:grid-cols-1 md:gird-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 py-3 items-center ">
            <div className='px-6 sm:px-4 md:px-2 lg:px-0 xl:px-0 2xl:px-0'>
              ...
              <p>Simplify project management with our streamlined solutions. We offer efficient tools and support to ensure smooth project execution, empowering your team to succeed effortlessly.</p>
