      ...
      <section className="w-full h-2/6">
        <div className="container mx-auto px-5 bg-gradient-to-br from-indigo-50 to-cyan-50 md:mt-10 rounded-3xl">
          <div className="sm:flex sm:justify-between sm:items-center px-3 py-6 sm:px-4 sm:py-6 md:px-3 md:py-8 lg:px-4 lg:py-7 xl:px-6 xl:py-8 2xl:px-8 2xl:py-10 gap-10 2xl:gap-16">
            ...
            {/* left item end */}
            {/* right item start */}
            <div className="overflow-hidden mt-5 sm:mt-0 sm:flex-1 p-5 sm:p-4 md:p-5 lg:p-4 xl:p-6 2xl:p-8">
              <img src={img} className='w-full h-full sm:w-full sm:h-56 md:w-full md:h-60 lg:w-full lg:h-64 xl:w-96 xl:h-[360px] 2xl:w-96 2xl:h-[380px] mx-auto'></img>
            </div>
            {/* right item end */}
          </div>
        </div>
