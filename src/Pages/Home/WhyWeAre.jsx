    ...
    <>
        <section  className="w-full h-2/6  pt-3 mb-16 mt-16" style={{ borderRadius:"5px 5px 5px 5px" }}>
            <div className="container mx-auto ">
               <div className="grid md:grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4">
                <div className="flex justify-center items-center ">
                    <div className='mx-2' data-aos="fade-right">
                        <div className="shadow-lg rounded p-3 text-center sm:2/6 lg:w-48  hover:shadow-xl ">
                            <lord-icon
                    ...
                    <div className='mx-2'>
                        <div className="shadow-lg rounded p-3 text-center sm:2/6 lg:w-48 hover:shadow-xl" data-aos="fade-left">
                        <lord-icon
                ...
                {/* who we are */}
                <div className='lg:ps-20 sm:ps-6 md:ps-12 px-6 sm:px-6 md:px-0 lg:px-0 '>
