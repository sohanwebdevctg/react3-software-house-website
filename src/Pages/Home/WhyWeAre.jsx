            ...
            <div className="container mx-auto ">
               <div className="lg:flex items-center justify-center gap-10  mb-12">
                ...
                <div className='pt-5 sm:pt-6 md:pt-8 lg:pt-10 px-6 sm:px-4 md:px-6 lg:px-0 '>
                    ...
                    <p className='mt-2 text-sm sm:text-base md:text-lg lg:text-lg text-slate-700 mb-6 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla consectetur amet, eius aspernatur nam nesciunt libero ipsum esse doloremque error quod explicabo, sint nihil reprehenderit? Rerum itaque deserunt nesciunt minima.</p>
